...
@section("content")
    ...
    <form action="{{ route("color.store") }}" id="color-form" method="post" accept-charset="utf-8" novalidate="novalidate">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ old("title") }}" class="form-control form-control-sm @error("title") is-invalid @enderror" placeholder="Category Name" id="cat_name">
                                @error("title")
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2 colorpicker-element">
                                    <input type="text" name="code" value="{{ old("color") }}" class="form-control form-control-sm @error('code') is-invalid @enderror" placeholder="" id="code">
