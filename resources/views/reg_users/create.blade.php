...
@section("content")
    <x-bread-crumb>
        <li class="breadcrumb-item"><a href="{{ route("reg-user-manager.index") }}">Users</a></li>
        <li class="breadcrumb-item active" aria-current="page">Add New User</li>
    </x-bread-crumb>


    <form action="{{ route("reg-user-manager.store") }}" id="category-form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
